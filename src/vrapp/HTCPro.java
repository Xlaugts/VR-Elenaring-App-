 ...
 * @author henri
 */
public class HTCPro extends  Parent {
    ...
    private void getVRData(){
        vrTextValue = localController.targetVR5.getVRTextData();
        vrfovValue = localController.targetVR5.getVRFov();
        vrpriceValue = localController.targetVR5.getVRPrice(); 
    }
    ...
    private void createNodesForUI(){
        ...
        nameLabel = new Label("HTC Vive Pro");
        
        imgdevice = new ImageView(new Image(getClass().getResourceAsStream("pro.png")));
