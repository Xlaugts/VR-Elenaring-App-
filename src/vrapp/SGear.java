 ...
 * @author henri
 */
public class SGear extends  Parent {
    ...
    private void getVRData(){
        vrTextValue = localController.targetVR1.getVRTextData();
        vrfovValue = localController.targetVR1.getVRFov();
        vrpriceValue = localController.targetVR1.getVRPrice(); 
    }
    ...
    private void createNodesForUI(){
        ...
        nameLabel = new Label("Samsung Gear VR");
        
        imgdevice = new ImageView(new Image(getClass().getResourceAsStream("sgear.png")));
