 ...
 * @author henri
 */
public class GDayDream extends  Parent {
    ...
    private void getVRData(){
        vrTextValue = localController.targetVR6.getVRTextData();
        vrfovValue = localController.targetVR6.getVRFov();
        vrpriceValue = localController.targetVR6.getVRPrice(); 
    }
    ...
    private void createNodesForUI(){
        ...
        nameLabel = new Label("Google DayDream View");
        
        imgdevice = new ImageView(new Image(getClass().getResourceAsStream("day.png")));
