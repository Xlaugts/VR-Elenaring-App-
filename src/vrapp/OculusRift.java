 ...
 * @author henri
 */
public class OculusRift extends  Parent {
    ...
    private void getVRData(){
        vrTextValue = localController.targetVR3.getVRTextData();
        vrfovValue = localController.targetVR3.getVRFov();
        vrpriceValue = localController.targetVR3.getVRPrice(); 
    }
    ...
    private void createNodesForUI(){
        ...
        nameLabel = new Label("Oculus Rift");
        
        imgdevice = new ImageView(new Image(getClass().getResourceAsStream("orift.png")));
