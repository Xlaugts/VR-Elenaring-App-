 ...
 * @author henri
 */
public class OculusGo extends  Parent {
    ...
    private void getVRData(){
        vrTextValue = localController.targetVR2.getVRTextData();
        vrfovValue = localController.targetVR2.getVRFov();
        vrpriceValue = localController.targetVR2.getVRPrice(); 
    }
    ...
    private void createNodesForUI(){
        ...
        nameLabel = new Label("Oculus Go");
        
        
        imgdevice = new ImageView(new Image(getClass().getResourceAsStream("ogo.png")));
