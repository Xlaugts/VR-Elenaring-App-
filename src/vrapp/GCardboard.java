 ...
 * @author henri
 */
public class GCardboard extends  Parent {
    ...
    private void getVRData(){
        vrTextValue = localController.targetVR7.getVRTextData();
        vrfovValue = localController.targetVR7.getVRFov();
        vrpriceValue = localController.targetVR7.getVRPrice(); 
    }
    ...
    private void createNodesForUI(){
        ...
        nameLabel = new Label("Google Cardboard");
            
imgdevice = new ImageView(new Image(getClass().getResourceAsStream("card.png")));
