 ...
 * @author henri
 */
public class HTCVive extends  Parent {
    ...
    private void getVRData(){
        vrTextValue = localController.targetVR4.getVRTextData();
        vrfovValue = localController.targetVR4.getVRFov();
        vrpriceValue = localController.targetVR4.getVRPrice(); 
    }
    ...
    private void createNodesForUI(){
        ...
        nameLabel = new Label("HTC Vive");
        
        imgdevice = new ImageView(new Image(getClass().getResourceAsStream("vive.png")));
